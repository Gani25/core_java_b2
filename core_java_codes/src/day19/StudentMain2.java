...
public class StudentMain2 {
	...
	public static void main(String[] args) {
		...
		Comparator<Student> comparator = (s1, s2) -> (Double.compare(s2.getPercentage(), s1.getPercentage()) == 0)? Integer.compare(s1.getRollNo(), s2.getRollNo()) : Double.compare(s2.getPercentage(), s1.getPercentage());
